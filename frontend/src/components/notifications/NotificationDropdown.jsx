      ...
      >
        ...
        {unreadCount > 0 && (
          <motion.span
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            className="absolute -top-1 -right-1 w-5 h-5 bg-error rounded-full text-xs font-bold text-gray-800 flex items-center justify-center"
          >
            ...
            <div className="max-h-96 overflow-y-auto">
              {notifications && notifications.length > 0 ? (
                ...
                <div className="p-8 text-center">
                  <Bell className="w-12 h-12 text-gray-800/20 mx-auto mb-3" />
