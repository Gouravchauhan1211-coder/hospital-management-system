...
const MediatorAppointmentsPage = () => {
 ...
 <th className="text-left text-sm text-gray-600 pb-3 font-medium">Doctor</th>
 ...
 <th className="text-left text-sm text-gray-600 pb-3 font-medium">Payment</th>
 ...
 <p className="text-xs text-gray-500">ID: {apt.patient_id?.slice(0, 8)}...</p>
 </div>
 </div>
 </td>
 <td className="py-4">
 ...
 <p className="text-gray-800">${selectedAppointment.amount || 0}</p>
 </div>
 </div>
