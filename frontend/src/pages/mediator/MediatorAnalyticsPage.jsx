  ...
  return (
    <DashboardLayout>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Status Breakdown */}
        <GlassCard className="p-6">
          <h3 className="text-lg font-semibold text-white mb-4">Appointment Status</h3>
              ...
              topDoctors.map((doctor, index) => (
                <div key={doctor.id} className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-white/40">{doctor.specialization}</p>
                  </div>
                  <div className="text-right">
                    <p className="text-white font-bold">{doctor.count}</p>
        ...
        <GlassCard className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-white/60">Total Appointments</p>
            </div>
          </div>
        </GlassCard>
      </div>
