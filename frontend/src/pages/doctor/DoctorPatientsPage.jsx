...
const DoctorPatientsPage = () => {
 ...
 <p className="text-xs text-gray-600">Completed Consultations</p>
 </div>
 </div>
 </GlassCard>
 <GlassCard className="p-4">
 ...
 <h3 className="text-gray-800 font-medium truncate">{patient.name}</h3>
 ...
 <p className="text-gray-800 font-medium capitalize">{selectedPatient.gender || 'N/A'}</p>
 </div>
 <div className="p-3 rounded-lg bg-gray-50">
 <p className="text-xs text-gray-600">Blood Group</p>
 <p className="text-gray-800 font-medium">{selectedPatient.blood_group || 'N/A'}</p>
 </div>
 <div className="p-3 rounded-lg bg-gray-50">
 ...
 <p className="text-gray-800 font-medium">{patientAppointments.length}</p>
 </div>
 </div>
 ...
 <p className="text-gray-800 bg-gray-50 p-3 rounded-lg">{selectedPatient.medical_history}</p>
 </div>
 )}
 ...
 <p className="text-gray-800 bg-red-500/10 p-3 rounded-lg border border-red-500/20">{selectedPatient.allergies}</p>
 </div>
 )}
 </div>
 )}
 ...
 {/* Recent Appointments */}
 <div>
 <h4 className="text-sm font-medium text-gray-800 mb-3">Recent Appointments</h4>
 ...
 <div>
 <p className="text-gray-800 text-sm">{format(new Date(apt.date), 'MMM d, yyyy')}</p>
 <p className="text-xs text-gray-600">{apt.time} • {apt.mode === 'online' ? 'Video Call' : 'In-Person'}</p>
 </div>
 <Badge variant={
 ...
 <h4 className="text-sm font-medium text-gray-800">Medical Records</h4>
 <Button
 variant="ghost"
 size="sm"
 ...
 <p className="text-gray-800 text-sm font-medium">{record.title}</p>
 <p className="text-xs text-gray-500">{format(new Date(record.created_at), 'MMM d, yyyy')}</p>
 </div>
 {record.description && (
 ...
 <p className="text-gray-500 text-sm text-center py-4">No medical records found</p>
 )}
 </div>
 ...
 className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-800 placeholder:text-gray-500 focus:outline-none focus:border-primary-500"
 />
 </div>
 <div>
