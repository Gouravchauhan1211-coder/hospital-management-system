...
const DoctorAvailabilityPage = () => {
 ...
 <h2 className="text-lg font-semibold text-gray-800 mb-6">Weekly Schedule</h2>
 ...
 <span className={`font-medium ${weeklySchedule[day].enabled ? 'text-gray-800' : 'text-gray-400'}`}>
 {day}
 </span>
 </div>
 ...
 <GlassCard className="p-6">
 <h2 className="text-lg font-semibold text-gray-800 mb-4">Unavailable Dates</h2>
 ...
 <GlassCard className="p-6">
 <h2 className="text-lg font-semibold text-gray-800 mb-4">Marked Unavailable</h2>
 ...
 <div>
 <p className="text-gray-800 font-medium">New Appointments</p>
 <p className="text-xs text-gray-500">Get notified for new bookings</p>
 </div>
 </div>
 <button
 ...
 <p className="text-xs text-gray-500">Remind 1 hour before</p>
 </div>
 </div>
 <button
 ...
 <div>
 <p className="text-gray-800 font-medium">Cancellations</p>
 <p className="text-xs text-gray-500">Get notified when patients cancel</p>
 </div>
 </div>
 <button
 ...
 className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-800 placeholder:text-gray-400 focus:outline-none focus:border-blue-500"
 />
 </div>
