...
<div className="grid grid-cols-1 gap-6">
 ...
 <div>
 <p className="text-2xl font-bold text-gray-800">{profile?.rating || '4.8'}</p>
 ...
 <div>
 <p className="text-2xl font-bold text-gray-800">{profile?.total_patients || 0}</p>
 ...
 {/* Specialization */}
 <div>
 <label className="block text-sm text-gray-600 mb-2">Specialization</label>
 {isEditing ? (
 <select
 ...
 {/* Bio */}
 <div className="mt-6">
 <label className="block text-sm text-gray-600 mb-2">About / Bio</label>
 {isEditing ? (
 <textarea
 value={editData.bio}
 ...
 {/* Consultation Fee */}
 <div className="mb-6">
 <label className="block text-sm text-gray-600 mb-2">Consultation Fee ($)</label>
 {isEditing ? (
 <input
 type="number"
 ...
 <p className="text-gray-800 text-2xl font-bold">${profile?.consultation_fee || 0}</p>
 )}
 </div>
 ...
 <div>
 <p className="text-gray-800 font-medium">{qual.degree}</p>
 ...
 {/* Languages */}
 <div>
 <label className="block text-sm text-gray-600 mb-2">Languages Spoken</label>
 {isEditing ? (
 <div className="space-y-3">
 ...
 className="flex-1 px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-gray-800 text-sm focus:outline-none focus:border-primary-500"
 onKeyPress={(e) => {
 if (e.key === 'Enter') {
 ...
 <div>
 <p className="text-gray-800 font-medium">Verified Doctor</p>
 <p className="text-sm text-gray-600">Your profile has been verified by the administration</p>
 </div>
 </>
 ) : (
 <>
 ...
 <div>
 <p className="text-gray-800 font-medium">Verification Pending</p>
 <p className="text-sm text-gray-600">Your profile is under review. You'll be notified once verified.</p>
 </div>
 </>
 )}
 </div>
