                      ...
                      <td className="py-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-white/40">{apt.specialization || 'General'}</p>
                          </div>
                        </div>
                      </td>
                      <td className="py-4">
                        ...
                        <div className="flex items-center gap-2">
                          {apt.mode === 'online' ? (
                            <>
                              ...
                              <span className="text-white/80">Video Call</span>
                            </>
                          ) : (
                            <>
                              <MapPin className="w-4 h-4 text-green-400" />
                              <span className="text-white/80">In-Person</span>
                            </>
                          )}
                        </div>
                      </td>
        ...
        {patientDetails && (
          <div className="space-y-4">
            <div className="flex items-center gap-4 pb-4 border-b border-white/10">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white">{patientDetails.full_name}</h3>
                <p className="text-sm text-white/60">{patientDetails.email}</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-white">{patientDetails.phone || 'N/A'}</p>
              </div>
              <div>
                <p className="text-sm text-white/60">Gender</p>
                <p className="text-white capitalize">{patientDetails.gender || 'N/A'}</p>
              </div>
              <div>
                <p className="text-sm text-white/60">Blood Group</p>
                <p className="text-white">{patientDetails.blood_group || 'N/A'}</p>
              </div>
              <div>
            ...
            {patientDetails.medical_history && (
              <div>
                <p className="text-sm text-white/60 mb-1">Medical History</p>
                <p className="text-white bg-white/5 p-3 rounded-lg">{patientDetails.medical_history}</p>
              </div>
            )}

            {patientDetails.allergies && (
              <div>
                <p className="text-sm text-white/60 mb-1">Allergies</p>
                <p className="text-white bg-white/5 p-3 rounded-lg">{patientDetails.allergies}</p>
              </div>
            )}
        ...
        <div className="space-y-4">
          {selectedAppointment && (
            <div className="p-3 bg-white/5 rounded-lg">
              ...
              <p className="text-sm text-white/60 mt-2">Date & Time</p>
              <p className="text-white">
          ...
          <div>
            <label className="block text-sm text-white/60 mb-2">Consultation Notes</label>
            <textarea
