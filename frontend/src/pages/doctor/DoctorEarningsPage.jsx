    ...
    <DashboardLayout>
        ...
        {isLoading ? (
          ...
          <>
                  ...
                  <div className="flex items-center gap-1 mt-2">
                    {stats.growth >= 0 ? (
                      <>
                        ...
                        <span className="text-sm text-green-400">+{stats.growth}%</span>
                      </>
                    ) : (
                      <>
                        <ArrowDownRight className="w-4 h-4 text-red-400" />
                        <span className="text-sm text-red-400">{stats.growth}%</span>
                      </>
                    )}
            ...
            <GlassCard className="p-6">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-white">${earnings.pendingPayout.toFixed(2)}</p>
                  <p className="text-xs text-white/40 mt-2">Available to withdraw</p>
                </div>
            ...
            <GlassCard className="p-6">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-sm text-white/60 mb-1">Avg. per Appointment</p>
                  <p className="text-3xl font-bold text-white">${stats.averagePerAppointment}</p>
                  <p className="text-xs text-white/40 mt-2">{stats.paidAppointments} paid appointments</p>
                </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-3">
                <select
                  ...
                  className="px-3 py-2 bg-white/5 border border-white/10 rounded-lg text-sm text-white focus:outline-none focus:border-primary-500"
                >
                ...
                {filteredTransactions.map((transaction, index) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-white font-medium">{transaction.patient_name || 'Patient'}</p>
        ...
        <div className="space-y-6">
          {/* Payout Summary */}
          <GlassCard className="p-6">
            <h2 className="text-lg font-semibold text-white mb-4">Payout Summary</h2>
            
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 rounded-lg bg-white/5">
                <span className="text-white/60">Available Balance</span>
                <span className="text-xl font-bold text-white">${earnings.pendingPayout.toFixed(2)}</span>
              </div>
              
              <div className="flex items-center justify-between p-3 rounded-lg bg-white/5">
                <span className="text-white/60">Total Withdrawn</span>
                <span className="text-white">${(earnings.totalEarnings - earnings.pendingPayout).toFixed(2)}</span>
              </div>
          ...
          <GlassCard className="p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 p-3 rounded-lg bg-white/5 border border-primary-500/50">
                <div className="w-10 h-10 rounded-lg bg-primary-500/20 flex items-center justify-center">
                  <Building2 className="w-5 h-5 text-primary-400" />
                </div>
                <div className="flex-1">
                  <p className="text-white font-medium">Bank Account</p>
                  <p className="text-xs text-white/60">**** **** **** 4532</p>
                </div>
              ...
              <div className="flex items-center gap-3 p-3 rounded-lg bg-white/5">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-white/60">doctor@email.com</p>
                </div>
              </div>
            </div>
          </GlassCard>
          ...
          <GlassCard className="p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-white/60">Completed Appointments</span>
                <span className="text-white font-medium">{stats.totalAppointments}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-white/60">Paid Appointments</span>
                <span className="text-white font-medium">{stats.paidAppointments}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-white/60">Collection Rate</span>
      ...
      >
        <div className="space-y-4">
          <div className="p-4 rounded-lg bg-white/5">
            ...
            <p className="text-2xl font-bold text-white">${earnings.pendingPayout.toFixed(2)}</p>
          </div>
          
          <div>
            <label className="block text-sm text-white/60 mb-2">Withdrawal Method</label>
            <select
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="0.00"
                className="w-full pl-8 pr-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white focus:outline-none focus:border-primary-500"
            ...
            <div className="flex gap-2 mt-2">
              <button
                ...
                className="px-3 py-1 text-xs bg-white/5 rounded-lg text-white/60 hover:bg-white/10"
              >
                25%
              </button>
              <button
