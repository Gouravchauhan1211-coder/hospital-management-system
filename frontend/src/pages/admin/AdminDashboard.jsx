...
const AdminDashboard = () => {
 ...
 <h2 className="text-lg font-semibold text-gray-800">Walk-in Queue</h2>
 ...
 <thead>
 <tr>
 <th className="text-left text-sm text-gray-600 pb-3">Patient</th>
 <th className="text-left text-sm text-gray-600 pb-3">Doctor</th>
 ...
 >
 <td className="py-3">
 <span className="text-gray-800">{apt.patient_name}</span>
 </td>
 <td className="py-3">
 <span className="text-gray-700">{apt.doctor_name}</span>
 </td>
 <td className="py-3">
 ...
 <span className="text-gray-800/70">Pending</span>
 </div>
 <span className="text-gray-800 font-medium">{analytics.statusCounts?.pending || 0}</span>
 </div>
 <div className="flex justify-between items-center">
 <div className="flex items-center gap-2">
 <div className="w-3 h-3 rounded-full bg-primary-500" />
 <span className="text-gray-800/70">Confirmed</span>
 </div>
 <span className="text-gray-800 font-medium">{analytics.statusCounts?.confirmed || 0}</span>
 </div>
 <div className="flex justify-between items-center">
 <div className="flex items-center gap-2">
 <div className="w-3 h-3 rounded-full bg-success" />
 <span className="text-gray-800/70">Completed</span>
 </div>
 <span className="text-gray-800 font-medium">{analytics.statusCounts?.completed || 0}</span>
 </div>
 <div className="flex justify-between items-center">
 <div className="flex items-center gap-2">
 <div className="w-3 h-3 rounded-full bg-error" />
 <span className="text-gray-800/70">Cancelled</span>
 </div>
 <span className="text-gray-800 font-medium">{analytics.statusCounts?.cancelled || 0}</span>
 </div>
 </div>
 </GlassCard>
 ...
 <span className="text-gray-700">Add Walk-in Patient</span>
