...
const PatientDoctorProfilePage = () => {
 ...
 <h1 className="text-2xl font-bold text-gray-800 mb-1">Dr. {doctor.full_name}</h1>
 ...
 <div className="text-3xl font-bold text-gray-800 mb-1">${doctor.fee || 0}</div>
 ...
 <p className="text-gray-800/70">{doctor.bio || 'No bio available'}</p>
 </GlassCard>
 ...
 <div className="flex items-center gap-1">
 {[...Array(5)].map((_, i) => (
 <Star key={i} className={`w-4 h-4 ${i < review.rating ? 'text-yellow-400 fill-yellow-400' : 'text-gray-800/20'}`} />
 ))}
 </div>
 </div>
 ...
 <div className="space-y-4">
 <div>
 <label className="block text-sm text-gray-800/70 mb-2">Select Date</label>
 ...
 : 'bg-gray-100 text-gray-800/70 hover:bg-white/20'
 }`}
 >
 ...
 {selectedDate && (
 <div>
 <label className="block text-sm text-gray-800/70 mb-2">
 Select Time
 ...
 selectedTime === time 
 ? 'bg-primary-500 text-gray-800 shadow-lg shadow-primary-500/30' 
 : 'bg-gray-100 text-gray-800/70 hover:bg-white/20'
 }`}
 >
 {time}
 ...
 <div>
 <label className="block text-sm text-gray-800/70 mb-2">Consultation Mode</label>
 ...
 <div>
 <label className="block text-sm text-gray-800/70 mb-2">Describe your symptoms</label>
 <textarea
 value={symptoms}
 onChange={(e) => setSymptoms(e.target.value)}
 placeholder="Describe your symptoms..."
 className="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-800 placeholder-white/40 focus:outline-none focus:border-primary-500"
 rows={3}
 />
 </div>
