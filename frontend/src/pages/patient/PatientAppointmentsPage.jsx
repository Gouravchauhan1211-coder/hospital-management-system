...
const PatientAppointmentsPage = () => {
 ...
 <Calendar className="w-16 h-16 text-gray-800/30 mx-auto mb-4" />
 ...
 {/* Select Doctor */}
 <div>
 <label className="block text-sm text-gray-800/70 mb-2">Select Doctor *</label>
 ...
 <p className="text-xs text-gray-800/50">{doctor.specialization}</p>
 </div>
 </div>
 </button>
 ))}
 ...
 className="w-full px-4 py-3 bg-gray-100 border border-gray-200 rounded-xl text-gray-800"
 />
 </div>

 {/* Time */}
 <div>
 <label className="block text-sm text-gray-800/70 mb-2">Select Time *</label>
 ...
 <span className="text-gray-800">In-Person</span>
 </button>
 </div>
 </div>
